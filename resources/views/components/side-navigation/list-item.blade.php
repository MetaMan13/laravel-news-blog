<li class="mb-2 group grid grid-cols-8 grid-rows-1 hover:bg-white rounded-md w-10/12 p-0.5 transition duration-250 ease-in-out">
    ...
    <a href="/breaking-news" class="text-lg group-hover:text-gray-900 transition duration-250 ease-in-out col-span-6 self-center ml-1.5">{{ $slot }}</a>
